...
const PROPERTY_CARD_PADDING_PX = 20;
const PROPERTY_ROW_HEIGHT_PX = 24;
const PROPERTY_TITLE_ROWS = 1;

function ProductPage({ onNavigate, backendAvailable = false }) {
    ...
    const propertiesCardMinHeight = `${(PROPERTY_TITLE_ROWS + propertiesList.length) * PROPERTY_ROW_HEIGHT_PX + PROPERTY_CARD_PADDING_PX}px`;
    ...
    return (
        <>
            ...
            <div style={{ marginLeft: '20px', marginRight: '20px' }}>
                ...
                <div style={{ minHeight: propertiesCardMinHeight, height: 'auto', border: '1px solid black', padding: '10px', marginBottom: '20px', width: 'fit-content' }}>
                ...
                <div style={{ border: '1px solid black', marginTop: '20px', paddingLeft: '20px' }}>
                    <p>
                        Not a carpenter? Not interested in making your own furniture? Then head on over to our{' '}
                        <a
                            style={{ color: 'blue' }}
                            href="#"
                            onClick={(e) => {
                        ...
                        section for our pre-built furniture!
                    </p>
                </div>
                <br /><br /><br />
            </div>
